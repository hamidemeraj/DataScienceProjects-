# LDA 
# LDA extracts new independent variables that seprate the most classes of the dependent variable
...
# Because it is a supervised model we should consider y_train 
