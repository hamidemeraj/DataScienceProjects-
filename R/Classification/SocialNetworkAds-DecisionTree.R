...
# Fit Decision Tree To the training set and Predict the test set results  
...
# it shows two column for probability of y_pred in each class 
...
# Plot Decision Tree (it is necessary to use the data without feature scaling)
# Import Data set 
df = read.csv("C:/Users/snapp/Data-Projects/Datasets/Social_Network_Ads.csv")
df = df[, 3:5]
