# Grid search 
# Grid Search: Find optimal values forparameters of models 
...
# Applying Grid seach to find the best parameters 
library(caret)
# Check caret package github to find the good model (Method parameters in below)
classifier = train(Purchased ~. , 
                   data = train_set, 
                   method = 'svmRadial'
                   )
classifier
classifier$bestTune
# You can use best parameters from this to above model 
